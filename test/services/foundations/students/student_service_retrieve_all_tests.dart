  ...
  group('retrieveAllStudentsAsync —', () {
    ...
    group('Happy Path |', () {
      test(
        ...
        'THEN it should return all students from storage',
        () async {
          // Arrange
          ...
          when(() => base.storageBrokerMock.selectAllStudentsAsync())
              .thenAnswer((_) async => storageStudents);

          // Act
          final List<Student> actualStudents =
              await base.studentService.retrieveAllStudentsAsync();
