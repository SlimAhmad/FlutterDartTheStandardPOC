...
void runRetrieveStudentByIdTests(StudentServiceTestBase base) {
  group('retrieveStudentByIdAsync —', () {
    group('retrieve byId |', () {
      test('GIVEN a valid studentId that exists in storage '
          'WHEN retrieveStudentByIdAsync is called '
          'THEN it should return the matching student', () async {
        // Arrange
    ...
    group('Dependency Exceptions |', () {
      test('GIVEN the storage broker throws an exception '
          'WHEN retrieveStudentByIdAsync is called '
          'THEN it should throw StudentDependencyException', () async {
        // Arrange
